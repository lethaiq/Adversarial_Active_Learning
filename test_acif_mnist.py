...
if __name__=="__main__":
    ...
    parser.add_argument('--id_experiment', type=int, default=1, help='id number of experiment')
    parser.add_argument('--repo', type=str, default='.', help='repository for log')
    parser.add_argument('--filename', type=str, default='mnist_ceal_v2', help='csv filename')
